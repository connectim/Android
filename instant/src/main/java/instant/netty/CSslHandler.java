...
/**
 * Created by puin on 17-11-19.
 */

public class CSslHandler extends ByteToMessageDecoder{
     ...
     */
    public CSslHandler(SSLEngine engine) {
        this(engine, false);
    }
     ...
     */
    public CSslHandler(SSLEngine engine, boolean startTls) {
        if (engine == null) {
