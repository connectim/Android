 ...
 */
public class SafetyPhoneNumberActivity extends BaseActivity {
    ...
    private SafetyPhoneNumberActivity mActivity;
    ...
    public static void startActivity(Activity activity, String type) {
        ...
        ActivityUtil.nextBottomToTop(activity, SafetyPhoneNumberActivity.class, bundle,-1);
    }
    ...
    void nextBtn(View view) {
        ...
        HttpRequest.getInstance().post(UriUtil.CONNECT_V1_SMS_SEND, sendMobileCode, new ResultCall<Connect.HttpNotSignResponse>() {
            ...
            public void onResponse(Connect.HttpNotSignResponse response) {
                ...
                SafetyPhoneVerifyActivity.startActivity(mActivity, countryBean.getCode(),phoneEt.getText().toString(), bundle.getString("type"));
            }
