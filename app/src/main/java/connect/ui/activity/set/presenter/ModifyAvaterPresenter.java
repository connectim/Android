...
import connect.ui.activity.set.contract.ModifyAvaterContract;
...
public class ModifyAvaterPresenter implements ModifyAvaterContract.Presenter{

    private ModifyAvaterContract.View mView;
    private MediaScannerConnection scanner;
    private String pathDcim;

    public ModifyAvaterPresenter(ModifyAvaterContract.View mView) {
        this.mView = mView;
    }
