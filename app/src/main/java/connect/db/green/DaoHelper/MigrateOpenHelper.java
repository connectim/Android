...
import connect.db.green.DaoHelper.mergin.MigrationHelper;
import connect.db.green.bean.ContactEntityDao;
...
import connect.db.green.bean.FriendRequestEntityDao;
import connect.db.green.bean.GroupEntityDao;
import connect.db.green.bean.GroupMemberEntityDao;
import connect.db.green.bean.MessageEntityDao;
import connect.db.green.bean.ParamEntityDao;
import connect.db.green.bean.RecommandFriendEntityDao;
import connect.db.green.bean.TransactionEntityDao;
import connect.utils.log.LogManager;
import connect.ui.activity.login.DBUpdateActivity;
