...
public class CurrencyEntityDao extends AbstractDao<CurrencyEntity, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Currency_code = new Property(1, Integer.class, "currency_code", false, "CURRENCY_CODE");
        public final static Property Address = new Property(2, String.class, "address", false, "ADDRESS");
        public final static Property Address_index = new Property(3, String.class, "address_index", false, "ADDRESS_INDEX");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CURRENCY_ENTITY\" (" + //
                ...
                "\"CURRENCY_CODE\" INTEGER," + // 1: currency_code
                "\"ADDRESS\" TEXT," + // 2: address
                "\"ADDRESS_INDEX\" TEXT," + // 3: address_index
    ...
    protected final void bindValues(DatabaseStatement stmt, CurrencyEntity entity) {
        ...
        String address_index = entity.getAddress_index();
        if (address_index != null) {
            stmt.bindString(4, address_index);
        }
    ...
    public CurrencyEntity readEntity(Cursor cursor, int offset) {
        CurrencyEntity entity = new CurrencyEntity( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1), // currency_code
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // address
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // address_index
    ...
    public void readEntity(Cursor cursor, CurrencyEntity entity, int offset) {
        ...
        entity.setCurrency_code(cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1));
        entity.setAddress(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setAddress_index(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
