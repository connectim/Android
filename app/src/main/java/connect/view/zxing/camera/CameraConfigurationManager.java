 ...
 */
package connect.view.zxing.camera;
...
public final class CameraConfigurationManager {
	...
	public void initFromCameraParameters(Camera camera) {
		...
		/** Because of the vertical screen display, so do not replace the screen width and height of the preview map is deformed */
	...
	public void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		/** Set camera preview for vertical screen */
	...
	/**
	 * The most suitable preview interface size is calculated from the camera supported resolution
	 * 
	 * @param parameters
